const CONFIG = {
  ...
  HEO_HERO_TITLE_3: 'QCODE.IM',
  HEO_HERO_TITLE_4: '持续记录与分享',
  HEO_HERO_TITLE_5: 'NotionNext 4.10 · 更完整的阅读体验',
  HEO_HERO_TITLE_LINK: 'https://qcode.im',
  // 英雄区遮罩文字
  ...
  HEO_SOCIAL_CARD_TITLE_1: 'QCODE 源码',
  HEO_SOCIAL_CARD_TITLE_2: '查看本站源码与最近更新',
  HEO_SOCIAL_CARD_TITLE_3: '前往 GitHub',
  HEO_SOCIAL_CARD_URL: 'https://github.com/cmerber/NotionNext',
